...
import { PredictionLoadingModal } from "@/components/molecules/PredictionLoadingModal";
...
export const InventoryPage: React.FC = () => {
  ...
  const handleSubmitInventory = async (formData: InventoryFormData) => {
    ...
    try {
      ...
      setError(
        err.message || "Failed to submit inventory form. Please try again.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-4xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
            ...
            <div className="text-center">
              <p className="text-gray-600 text-sm sm:text-base">
                Complete your individual inventory to help us provide
                personalized support
              </p>
              <p className="text-primary-600 text-xs sm:text-sm mt-1">
                Step 2 of 2 - Final assessment for comprehensive mental health
                evaluation
              </p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
            ...
            <div className="flex flex-col sm:flex-row items-start">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="mt-2 text-xs sm:text-sm text-primary-800">
                  <p className="mb-2">
                    This comprehensive form helps us understand your personal,
                    family, and health background to provide you with the most
                    appropriate mental health support and resources.
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-left">
                    <li>
                      Generates your personalized mental health risk assessment
                    </li>
                    <li>
                      Provides tailored recommendations based on your profile
                    </li>
                    <li>
                      Helps connect you with the most suitable support services
                    </li>
                    <li>
                      Creates a baseline for tracking your progress over time
                    </li>
                  </ul>
                  <p className="mt-3 font-medium">
                    Your information is completely confidential and will only be
                    used to enhance your care.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 sm:mt-8 bg-gray-100 rounded-lg p-3 sm:p-4">
            <p className="text-xs text-gray-600 text-center leading-relaxed">
              🔒 Your personal information is protected and handled in
              accordance with privacy laws and university policies. This
              information will be used solely for providing mental health
              support and will not be shared without your consent except as
              required by law or in case of immediate safety concerns.
            </p>
          </div>
        </div>
      </div>
