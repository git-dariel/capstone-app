...
export const LandingPage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Seamless booking system for counseling sessions with real-time availability.",
    ...
    },
    {
      ...
      description:
        "Guided therapeutic exercises, mindfulness sessions, and interactive wellness content to support mental well-being.",
      color: "from-gray-100 to-gray-50",
    },
    {
      icon: TrendingUp,
      ...
      description:
        "Comprehensive dashboard with data-driven insight and historical tracking for mental health trends.",
      color: "from-primary-100 to-primary-50",
    },
    {
      icon: Shield,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4">
            ...
            <div className="text-xs text-gray-500 pt-4 border-t border-gray-200">
              <p>
                © 2025 Office of Guidance and Counseling Services. Academic use only. All rights
                reserved.
              </p>
