...
export const ViewRetakeRequestDrawer: React.FC<ViewRetakeRequestDrawerProps> = ({
  isOpen,
  onClose,
  request,
  canReview = false,
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center space-x-3">
                <span
                  className={`inline-flex px-3 py-1 text-sm font-medium rounded-full ${statusInfo.bgColor} ${statusInfo.color}`}
                >
                  {statusInfo.label}
                </span>
              </div>
            ...
            {request.reviewedAt && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  {request.reviewer && (
                    <div className="text-xs text-gray-600 mt-1">
                      Reviewed by {request.reviewer.person?.firstName}{" "}
          ...
          <div className="border-t pt-6">
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                ...
                className="bg-green-600 hover:bg-green-700 text-white flex-1 flex items-center justify-center"
              >
              ...
              <Button
                ...
                className="text-red-600 border-red-300 hover:bg-red-50 flex-1 flex items-center justify-center"
              >
