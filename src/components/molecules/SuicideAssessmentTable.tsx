...
export const SuicideAssessmentTable: React.FC = () => {
  ...
  const allAssessments: SuicideAssessment[] = useMemo(() => {
    return apiAssessments.map((assessment: ApiSuicideAssessment) => {
      ...
      return {
        ...
        avatar: (assessment.user as any)?.avatar, // Access optional avatar safely
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="px-4 md:px-6 py-4 border-b border-gray-200">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
          <div>
            <h2 className="text-lg font-medium text-gray-900">Suicide Assessment Reports</h2>
        ...
        {error ? (
          ...
          <div className="flex items-center justify-center py-8">
            <div className="text-center text-gray-500">
              <p className="text-sm">No suicide assessments found</p>
